                        ...
                        <nav class="navbar navbar-expand-lg navbar-light justify-content-between">
                            ...
                            <c:if test="${sessionScope.id!=null }">
                             <c:if test="${sessionScope.admin=='n' }">
                               <a href="../mypage/mypage_main.do" class="btn d-none d-lg-block" style="color:orange;">내 정보</a>
                               &nbsp;<a href="../member/logout.do" class="btn d-none d-lg-block" id="logoutBtn" style="color:orange;">로그아웃</a>
                             </c:if>
                             <c:if test="${sessionScope.admin=='y' }">
                               <a href="../adminpage/admin_main.do" class="btn d-none d-lg-block" style="color:orange;">관리자페이지</a>
                               &nbsp;<a href="../member/logout.do" class="btn d-none d-lg-block" id="logoutBtn" style="color:orange;">로그아웃</a>
                             </c:if>
                            </c:if>
                        </nav>
