   ...
   <form method="post" action="../member/join_update_ok.do" name="join_frm" id="join_frm">
    <table class="table">
      ...
      <tr>
       ...
       <td width=85%>
         <input type=text name=address1 id=address1 size=95 class="input-sm" readonly value="${vo.address1 }">
       </td>
      </tr>
      <tr>
       <th class="text-right" width=15%>상세주소</th>
       <td width=85%>
         <input type=text name=address2 id=address2 size=95 class="input-sm" value="${vo.address2 }">
       </td>
      </tr>
      <tr>
       <th class="text-right" width=15%>전화번호</th>
       <td width=85% class="inline">
         <input type=text name=phone id=phone size=25 class="input-sm" value="${vo.phone }">
